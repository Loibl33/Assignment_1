...
public class EquipAllowedForCharacter extends HashMap<Class, ArrayList<Class>> {
    ...
    private EquipAllowedForCharacter() {
        ...
        ArrayList<Class> Rouge = new ArrayList<Class>();
        Rouge.add(Dagger.class);
        Rouge.add(Sword.class);
        Rouge.add(Leather.class);
        Rouge.add(Mail.class);
