...
class WarriorTest {
    ...
    void Warrior_NoConditions_PropertiesShouldBeSetCorrectly() {
        String shouldStats = "Character{Class=class Characters.Warrior, damage=1, name='Warrior1', level=1, Strength=5, Dexterity=2, Intelligence=1, dps=1}";
    ...
    void increaseLevel_WarriorExists_WarriorLevelShouldBeIncreasedCorrectly() {
        ...
        String shouldStats = "Character{Class=class Characters.Warrior, damage=4, name='Warrior1', level=2, Strength=8, Dexterity=4, Intelligence=2, dps=1}";
        String isStats = warrior.stats();
        Assertions.assertAll(
                () -> assertEquals(shouldStats, isStats)
        );
